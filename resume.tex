...
\begin{onecolentry}
    \begin{highlights}
        \item Guided a team of student interns in building a minimal web platform, “College Print Shop,” focusing on UI/UX, frontend, and backend workflows.
        \item Provided hands-on mentorship in design thinking, interface structuring, and real-world application of web technologies.
        \item Reviewed student progress, offered technical feedback, and helped troubleshoot issues across the development cycle.
    \end{highlights}
\end{onecolentry}
